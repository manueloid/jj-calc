...
final_times = range(0.2, 0.9, length=100)
sensitivities_esta, sensitivities_sta = sensitivities(20, final_times)
using Plots
plot(final_times, sensitivities_esta, label="esta")
plot!(final_times, sensitivities_sta, label="sta")
